...
func _on_SignUpButton_pressed():
	...
	var sign_up_url = "https://clerk.main.alien-31.lcl.dev/v1/client/sign_ups?_is_native=1"
	...
	if sign_ups.status_code == 200:
		...
		var sign_up_verify = str("https://clerk.main.alien-31.lcl.dev/v1/client/sign_ups/",  sign_up_id, "/prepare_verification")
